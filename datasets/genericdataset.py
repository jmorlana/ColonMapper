...
class ImagesFromList(data.Dataset):
    ...
    def __init__(self, root, images, imsize=None, transform=None, loader=default_loader, central_crop=None):
    ...
    def __getitem__(self, index):
        ...
        if self.central_crop is not None:
            # central_crop = [157, 910, 163, 876]
            print('Central cropping')
            img = img[:, self.central_crop[2]:self.central_crop[3], self.central_crop[0]:self.central_crop[1]]
